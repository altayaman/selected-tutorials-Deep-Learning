...
try {
	...
	dv_handler118.prototype = dv_baseHandlerIns;
dv_handler118.prototype.constructor = dv_handler118;

    var dv_handlersDefs = [{handler: new dv_handler118(), minRate: 0, maxRate: 90}];
