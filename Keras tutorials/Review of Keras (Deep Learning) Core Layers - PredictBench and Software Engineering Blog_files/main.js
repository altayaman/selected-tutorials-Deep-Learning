...
jQuery(document).ready(function(){	
	...
	if (jQuery(".journal-post a.cbp-lightbox, a.open-video.cbp-lightbox").length) { 
		jQuery(".journal-post a.cbp-lightbox, a.open-video.cbp-lightbox").nivoLightbox()
	};
	...
	***************************************************************/
	 ...
	 */
	if (typeof PreloaderParam != 'undefined' && !!window.addEventListener) {
...
jQuery(window).load(function($){   
	...
	***************************************************************/
	...
	if (typeof twitter_slideshow == 'undefined')
	var twitter_slideshow=true;
	if (typeof twitter_slideshowSpeed == 'undefined')
	var twitter_slideshowSpeed=3500;
	if (typeof twitter_animationDuration == 'undefined')
    var	twitter_animationDuration=1000;
	if (typeof twitter_directionNav == 'undefined')
	var twitter_directionNav=false;
	if (typeof twitter_controlNav == 'undefined')
	var twitter_controlNav=true;
